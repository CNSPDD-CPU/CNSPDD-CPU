...
<div class="pi-page">
    ...
    <section class="pi-hero" aria-labelledby="pi-page-title">
        <div class="pi-hero-heading">
            ...
            <h1 id="pi-page-title" tabindex="-1">Pin Li</h1>
        </div>
    ...
    <article class="pi-feature" aria-labelledby="pin-li-name">
        <div class="pi-person">
            <div class="pi-photo-frame">
                <img class="pi-photo" src="{{ '/assets/images/pi/pin-li.jpg' | relative_url }}" alt="Pin Li, Professor at China Pharmaceutical University" width="640" height="800" loading="eager" fetchpriority="high" decoding="async">
            </div>
            <div class="pi-person-meta">
                ...
                <p class="pi-person-note">Vascular biology · Translational therapeutics</p>
        ...
        <div class="pi-detail">
            ...
            <section class="pi-focus" aria-labelledby="pin-li-focus">
                <h3 class="pi-section-label" id="pin-li-focus">Research focus</h3>
                <p class="pi-section-note">Mechanisms, disease models, and therapeutic translation.</p>
                <div class="pi-tags">
            ...
            <section class="pi-publications" aria-labelledby="pin-li-publications">
                <h3 class="pi-section-label" id="pin-li-publications">Representative publications</h3>
                <ul class="pi-list">
            ...
            <section class="pi-patents" aria-labelledby="pin-li-patents">
                <h3 class="pi-section-label" id="pin-li-patents">Patents</h3>
                <ul class="pi-list">
