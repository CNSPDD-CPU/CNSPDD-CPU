    ...
    <section class="template-section contact-location-section" aria-labelledby="location-title">
        ...
        <div class="contact-location-module">
            <div class="contact-location-map">
                <iframe class="contact-map-frame" src="https://www.openstreetmap.org/export/embed.html?bbox=118.9040%2C31.8960%2C118.9230%2C31.9130&amp;layer=mapnik&amp;marker=31.90448%2C118.91339" title="Interactive map of China Pharmaceutical University Jiangning Campus" loading="lazy" referrerpolicy="no-referrer"></iframe>
            </div>
