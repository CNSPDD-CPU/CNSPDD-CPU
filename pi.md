...
<div class="pi-page">
    <section class="pi-hero" aria-labelledby="pi-page-title">
        <div>
            <p class="pi-eyebrow">PI Team · Experimental Platform</p>
            <h1 id="pi-page-title">Principal Investigator Team</h1>
        </div>
        <div>
            <p class="pi-hero-copy">Meet the investigators connecting vascular biology, disease mechanisms, and translational drug development across the platform.</p>
